...
| ---------------------------------------- | --------------------------------------------------------------- | -------- | --------------------------------------------- |
| **Rectificación de autoliquidación**     | Errores del contribuyente (IRPF, IVA, etc.)                     | _4 años_ | AEAT                                          |
| **Devolución de ingresos indebidos**     | Hacienda cobró de más o por error                               | _4 años_ | AEAT                                          |
| **Recurso de reposición**                | Contra liquidaciones o actos que ponen fin a vía administrativa | _1 mes_  | AEAT                                          |
| **Reclamación económico-administrativa** | Contra actos tributarios (sin necesidad de reposición previa)   | _1 mes_  | Tribunal Económico-Administrativo (TEAR/TEAC) |
| **Suspensión de la deuda**               | Para evitar embargo mientras se recurre                         | Variable | AEAT / TEAR                                   |

> 💡 _Reposición es opcional._ Puedes ir **directamente a reclamación económico-administrativa**, salvo excepciones.
